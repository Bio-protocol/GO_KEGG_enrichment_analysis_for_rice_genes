...
# save results
write.table(godb_BP, "cache/godb_BP.txt", sep = "\t", quote = FALSE, row.names = FALSE) #change dir
write.table(godb_MF, "cache/godb_MF.txt", sep = "\t", quote = FALSE, row.names = FALSE) #change dir
write.table(godb_CC, "cache/godb_CC.txt", sep = "\t", quote = FALSE, row.names = FALSE) #change dir
